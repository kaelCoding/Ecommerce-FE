import{A as C,a2 as v,a3 as S,a4 as E,a5 as B,a6 as y,a7 as W,a8 as H,a9 as $,aa as V,ab as U,ac as K,ad as g}from"./index-DqITul0o.js";const Ke=async(e=null)=>{try{let t="/chat/history";return e&&(t+=`?userId=${e}`),await C("GET",t)}catch(t){throw t}};/**
 * @license
 ...
 */const G="/firebase-messaging-sw.js",q="/firebase-cloud-messaging-push-scope",P="BDOU99-h67HcA6JeFXHbSNMu7e2yNNu3RzoMj8TM4W88jITfq7ZmPvIM1Iv-4_l2LxQcYwhqby2xGpWwzjfAnG4",Y="https://fcmregistrations.googleapis.com/v1",R="google.c.a.c_id",J="google.c.a.c_l",z="google.c.a.ts",Q="google.c.a.e",I=1e4;var A;(function(e){e[e.DATA_MESSAGE=1]="DATA_MESSAGE",e[e.DISPLAY_NOTIFICATION=3]="DISPLAY_NOTIFICATION"})(A||(A={}));/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ae(e,t){const n=t.data;if(!n.isFirebaseMessaging)return;e.onMessageHandler&&n.messageType===p.PUSH_RECEIVED&&(typeof e.onMessageHandler=="function"?e.onMessageHandler(D(n)):e.onMessageHandler.next(D(n)));const o=n.data;be(o)&&o[Q]==="1"&&await Ee(e,n.messageType,o)}const M="@firebase/messaging",N="0.12.23";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _e=e=>{const t=new me(e.getProvider("app").getImmediate(),e.getProvider("installations-internal").getImmediate(),e.getProvider("analytics-internal"));return navigator.serviceWorker.addEventListener("message",n=>Ae(t,n)),t},Oe=e=>{const t=e.getProvider("messaging").getImmediate();return{getToken:o=>x(t,o)}};function De(){v(new E("messaging",_e,"PUBLIC")),v(new E("messaging-internal",Oe,"PRIVATE")),S(M,N),S(M,N,"esm2020")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
